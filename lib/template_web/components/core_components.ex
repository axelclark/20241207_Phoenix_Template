defmodule TemplateWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TemplateWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TemplateWeb.Gettext, "errors", msg, opts)
    end
  end
